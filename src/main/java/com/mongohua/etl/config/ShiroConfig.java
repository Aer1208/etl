...
public class ShiroConfig {
    ...
    public HashedCredentialsMatcher hashedCredentialsMatcher(){
        ...
        hashedCredentialsMatcher.setHashIterations(Constant.MD5_CNT);
    ...
    public SecurityManager securityManager(){
        ...
        securityManager.setRealm(etlShiroRealm());
    ...
    public DefaultAdvisorAutoProxyCreator createAdvisorAutoProxyCreator() {
