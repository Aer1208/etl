...
var float=btn.float;
if (float == null ) {float="left";}
if(btn=="-" || btn.text=="-"){
    $("<div class=\"datagrid-btn-separator\"></div>").css("float",float).appendTo(tb);
}else{
var tool=$("<a href=\"javascript:void(0)\"></a>");
tool[0].onclick=eval(btn.handler||function(){
});
tool.css("float",float).appendTo(tb).linkbutton($.extend({},btn,{plain:true}));
}
}
}
